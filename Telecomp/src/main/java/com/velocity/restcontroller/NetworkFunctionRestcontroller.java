...
public class NetworkFunctionRestcontroller {
	...
	@PostMapping("/saveNetworkFunction")
	public NetworkFunction saveNetworkFunction(@RequestBody NetworkFunction networkfunction) {

		NetworkFunction net = networkfunctionservice.saveNetworkFunction(networkfunction);
		return net;
